  ...
  return (
      <div>
          <ContentBlock>
            ...
            <p className='mb-3'>Both books can be bought together for the <strong>reduced price of £30</strong>. P&P is £5 per order.</p>
            <p className='mb-8'>This website is under development, and so we can not currently take payment here. However, if you'd like to email the author with a purchase order, payment can be made directly using PayPal. Please <strong className=' underline'><Link to='/contact'>contact the author</Link></strong> for details.</p>
          </ContentBlock>
